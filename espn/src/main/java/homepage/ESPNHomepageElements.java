...
public class ESPNHomepageElements {
    ...
    // NFL Dropdown
    public static final String webElementNFLDropdown = "//a[@name='&lpos=sitenavdefault+sitenav_nfl']";

    // NFL Dropdown Menu (Left Section)
    public static final String webElementNFLDropdownMenu = "//*[@id=\"global-nav\"]/ul/li[1]/div/ul[1]";

    // NFL Dropdown Menu (Right Section)
    public static final String webElementNFLDropdownMenuTeams = "//*[@id=\"global-nav\"]/ul/li[1]/div/ul[2]";
