...
public class AffiliatesPageTest extends WebAPI {
    ...
    @Test(priority = 15)
    public void testValidatePostPhoto() throws IOException, InterruptedException {
        getInItElements();
        Assert.assertTrue(affiliatesPage.validatePostPhoto());
      }
    @Test(priority = 16)
    public void testValidatePostReview() throws IOException, InterruptedException {
        getInItElements();
        Assert.assertTrue(affiliatesPage.validatePostReview());
     }
